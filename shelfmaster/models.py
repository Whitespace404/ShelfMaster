...
class Entity(db.Model):
    id = sa.Column(sa.Integer, primary_key=True, unique=True)
    type = sa.Column(sa.String(7))
    accession_number = sa.Column(sa.String(7), unique=True)
    author = sa.Column(sa.String(100))
    title = sa.Column(sa.String(100))
    call_number = sa.Column(sa.String(15))
    publisher = sa.Column(sa.String(63))
    isbn = sa.Column(sa.String(20))
    vendor = sa.Column(sa.String(31))
